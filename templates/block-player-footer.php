...
?>
<footer
    class="sticky bottom-0 inset-x-0 z-50 bg-slate-950/95/80 backdrop-blur border-t border-slate-900/80"
    aria-label="<?php esc_attr_e('Global audio player', 'wp-corbidev-songs-player-theme'); ?>"
>
    <div class="w-full px-3 md:px-4 lg:px-6 py-3">
        <div class="w-full max-w-6xl mx-auto rounded-2xl bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 border border-slate-800/80 shadow-[0_-6px_24px_rgba(0,0,0,0.9)] px-3 md:px-4 lg:px-5 py-2 flex flex-col md:flex-row items-stretch md:items-center gap-3 md:gap-4">
            <div class="min-w-0 flex-1 flex items-center gap-3">
            <div
                class="relative h-11 w-11 rounded-lg overflow-hidden bg-slate-900/80 border border-slate-800 shadow-md shadow-black/50 flex-shrink-0"
            ...
            >
                <img
                    src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/no-audio.svg' ); ?>"
            ...
            >
                <img
                    src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/icon-toggle.svg' ); ?>"
                    alt=""
                    class="h-5 w-5"
                    aria-hidden="true"
                />
            ...
            <div class="min-w-0 flex-1">
                <p id="corbidev-footer-title" class="text-sm font-semibold text-slate-50 truncate" data-corbi-footer-title>
                ...
                <div class="mt-2 flex flex-col gap-1">
                    ...
                    >
                        <span class="absolute inset-y-0 left-0 w-0 bg-indigo-500 group-hover:bg-indigo-400" data-corbi-seek-fill></span>
                    </button>
                </div>
            </div>
        </div>
        <div class="mt-2 md:mt-0 flex items-center gap-3 justify-center">
            ...
            >
                <img
                    src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/icon-prev.svg' ); ?>"
                    alt=""
                    class="h-5 w-5"
                    aria-hidden="true"
                />
            ...
            >
                <img
                    src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/icon-play.svg' ); ?>"
                    alt=""
                    class="h-5 w-5"
                    aria-hidden="true"
                    data-corbi-icon-play
                />
                <img
                    src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/icon-pause.svg' ); ?>"
                    alt=""
                    class="h-5 w-5 hidden"
                    aria-hidden="true"
                    data-corbi-icon-pause
                />
            </button>
            <button
                type="button"
            ...
            >
                <img
                    src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/icon-next.svg' ); ?>"
                    alt=""
                    class="h-5 w-5"
                    aria-hidden="true"
                />
        ...
        <div class="mt-2 md:mt-0 flex items-center gap-4 justify-between md:justify-start flex-wrap">
            <div class="flex items-center gap-3">
                ...
                >
                    <img
                        src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/icon-heart-off.svg' ); ?>"
                        alt=""
                        class="h-5 w-5"
                        aria-hidden="true"
                        data-corbi-icon-fav-off
                    />
                    <img
                        src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/icon-heart-on.svg' ); ?>"
                        alt=""
                        class="h-5 w-5 hidden"
                        aria-hidden="true"
                        data-corbi-icon-fav-on
                    />
                </button>
                <button
                    type="button"
                ...
                >
                    <img
                        src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/icon-download.svg' ); ?>"
                        alt=""
                        class="h-5 w-5"
                        aria-hidden="true"
                    />
                ...
                <div class="flex items-center gap-1 w-28">
                    <img
                        src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/icon-volume.svg' ); ?>"
                        alt=""
